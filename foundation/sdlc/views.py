...
from foundation.models import Sdlc
from foundation.serializers import SdlcSerializer
from user_management.common.utils import api_response, api_error_response
from django.http import Http404

modelName = "Sdlc"
notFound = "Sdlc not found"
ModelName = Sdlc
SerializerName = SdlcSerializer


class SdlcList(APIView):
