...
from foundation.models import Complexity
from foundation.serializers import ComplexitySerializer
from user_management.common.utils import api_response, api_error_response
from django.http import Http404

modelName = "Complexity"
notFound = "Complexity not found"
ModelName = Complexity
SerializerName = ComplexitySerializer
...
class ComplexityDetail(APIView):
