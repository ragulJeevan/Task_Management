...
class Task(models.Model):
    ...
    opened_by_id = models.ForeignKey(User,related_name='task_opened_by', on_delete=models.CASCADE,blank=True, null=True)  
...
class Task_History(models.Model):
    ...
    feature_id = models.ForeignKey(Feature, on_delete=models.CASCADE)
    usecase_id = models.ForeignKey(Usecase, on_delete=models.CASCADE)
    created_by = models.ForeignKey(User, related_name='task_history_created_by', on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_by = models.ForeignKey(User, related_name='task_history_updated_by', on_delete=models.CASCADE, blank=True, null=True)  
    updated_at = models.DateTimeField(auto_now=True)
    status_id = models.ForeignKey(Status, on_delete=models.CASCADE)
    type_id = models.ForeignKey(Type, on_delete=models.CASCADE)
    stage_id = models.ForeignKey(Stage, on_delete=models.CASCADE)
    ...
    priority_id = models.ForeignKey(Priority, on_delete=models.CASCADE)
    sdlc_id = models.ForeignKey(Sdlc, on_delete=models.CASCADE)
    opened_by_id = models.ForeignKey(User,related_name='task_history_opened_by', on_delete=models.CASCADE,blank=True, null=True)  
    assignee_id = models.ForeignKey(User,related_name='task_history_assignee', on_delete=models.CASCADE, blank=True, null=True)  
    est_hours = models.IntegerField(default=0)
    actual_hours = models.IntegerField(default=0)
    start_date = models.DateField(blank=True, null=True)
    end_date = models.DateField(blank=True, null=True)
